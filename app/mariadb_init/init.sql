-- Elimina il database se esiste già (attenzione: questa operazione cancella tutti i dati)
...
CREATE TABLE movies (
    ...
    eta_autore INT,                         -- Età del regista (o valore d'interesse) al momento del rilascio
    anno INT,                               -- Anno di uscita del film
    genere VARCHAR(100),                    -- Genere del film
    piattaforma_1 VARCHAR(100),             -- Prima piattaforma su cui il film è disponibile
    piattaforma_2 VARCHAR(100)              -- Seconda piattaforma (NULL se non presente)
);

-- =====================================================

-- Inserimento dei dati nella tabella "films"
INSERT INTO movies (titolo, regista, eta_autore, anno, genere, piattaforma_1, piattaforma_2) VALUES
  ...
  ('Saving Private Ryan', 'Denis Villeneuve', 57, 2016, 'Fantascienza', 'Netflix', 'Paramount+'),
